...
```
docker run --rm --name api-layer --net host -d jbalhar/api-layer-development:1.14.1 /sbin/my_init
...
```
docker run --rm --name api-layer -d jbalhar/api-layer-development:1.14.1 /sbin/my_init
